...
//        }
        ...
        {
            try {
                com.inavr.bluetoothlibrary.tradition.AutoPair.setPairingConfirmation(btDevice.getClass(), btDevice, true);
                //2.终止有序广播
                abortBroadcast();//如果没有将广播终止，则会出现一个一闪而过的配对框。
                //3.调用setPin方法进行配对...
                boolean ret = com.inavr.bluetoothlibrary.tradition.AutoPair.setPin(btDevice.getClass(), btDevice, "0000");
                if (!ret) {
